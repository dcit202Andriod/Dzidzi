...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.dzidzi.Models.Recipe recipe6 = new Recipe(7, getResources().getString(R.string.goat_light_soup_name), getResources().getIdentifier("fufu_supper", "mipmap", getPackageName() ), getResources().getString(R.string.goat_light_soup_ingredients), getResources().getString(R.string.goat_light_soup_instructions), 3);
        com.example.dzidzi.Models.Recipe recipe7 = new Recipe(8, getResources().getString(R.string.oat_name), getResources().getIdentifier("oats", "mipmap", getPackageName() ), getResources().getString(R.string.oat_ingredients), getResources().getString(R.string.oat_instructions), 1);
        com.example.dzidzi.Models.Recipe recipe8 = new Recipe(9, getResources().getString(R.string.rice_balls_name), getResources().getIdentifier("riceballs", "mipmap", getPackageName() ), getResources().getString(R.string.rice_balls_ingredients), getResources().getString(R.string.rice_balls_instructions), 2);
        com.example.dzidzi.Models.Recipe recipe9 = new Recipe(10, getResources().getString(R.string.CornPorridgeTitle), getResources().getIdentifier("corn_porridge_breakfast", "mipmap", getPackageName() ), getResources().getString(R.string.CornPorridgeIngredients), getResources().getString(R.string.CornPorridgeInstructions), 1);
        com.example.dzidzi.Models.Recipe recipe10 = new Recipe(11, getResources().getString(R.string.AmpesiwithKontomireTitle), getResources().getIdentifier("ampesi_lunch", "mipmap", getPackageName() ), getResources().getString(R.string.AmpesiwithKontomireIngredients), getResources().getString(R.string.AmpesiwithKontomireInstructions), 2);
        com.example.dzidzi.Models.Recipe recipe11 = new Recipe(12, getResources().getString(R.string.TuoZaafiTitle), getResources().getIdentifier("tuozafi_supper", "mipmap", getPackageName() ), getResources().getString(R.string.TuoZaafiIngredients), getResources().getString(R.string.TuoZaafiInstructions), 3);
        com.example.dzidzi.Models.Recipe recipe12 = new Recipe(13, getResources().getString(R.string.OblayoTitle), getResources().getIdentifier("oblayo_breakfast", "mipmap", getPackageName() ), getResources().getString(R.string.OblayoIngredients), getResources().getString(R.string.OblayoInstructions), 1);
        com.example.dzidzi.Models.Recipe recipe13 = new Recipe(14, getResources().getString(R.string.KokonteandGroundnutSoupTitle), getResources().getIdentifier("kokonte_lunch", "mipmap", getPackageName() ), getResources().getString(R.string.KokonteandGroundnutSoupIngredients), getResources().getString(R.string.KokonteandGroundnutSoupInstructions), 2);
        com.example.dzidzi.Models.Recipe recipe14 = new Recipe(15, getResources().getString(R.string.BeansandplantainTitle), getResources().getIdentifier("gobe_supper", "mipmap", getPackageName() ), getResources().getString(R.string.BeansandplantainIngredients), getResources().getString(R.string.BeansandplantainInstructions), 3);
        com.example.dzidzi.Models.Recipe recipe15 = new Recipe(16, getResources().getString(R.string.TigernutPuddingTitle), getResources().getIdentifier("pudding_breakfast", "mipmap", getPackageName() ), getResources().getString(R.string.TigernutPuddingIngredients), getResources().getString(R.string.TigernutPuddingInstructions), 1);
        com.example.dzidzi.Models.Recipe recipe16 = new Recipe(17, getResources().getString(R.string.AttiekewithGrilledTilapiaTitle), getResources().getIdentifier("attieke_lunch", "mipmap", getPackageName() ), getResources().getString(R.string.AttiekewithGrilledTilapiaIngredients), getResources().getString(R.string.AttiekewithGrilledTilapiaInstructions), 2);
        com.example.dzidzi.Models.Recipe recipe17 = new Recipe(18, getResources().getString(R.string.EbunuebunuTitle), getResources().getIdentifier("ebunuebunu_supper", "mipmap", getPackageName() ), getResources().getString(R.string.EbunuebunuIngredients), getResources().getString(R.string.EbunuebunuInstructions), 3);
